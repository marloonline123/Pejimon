        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              task &quot;{task.name}&quot; and remove its data from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
              ...
              {statusTasks.map((task) => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <span
                      className="font-medium text-primary line-clamp-1 cursor-pointer hover:underline"
                      onClick={() => onEdit(task)}
                    >
                      {task.name}
                    </span>
        ...
        >
          <div className="flex-1">
            <div className="flex items-center justify-between mb-2">
              <span
                className="text-lg font-semibold cursor-pointer hover:underline text-primary"
                onClick={() => onEdit(task)}
              >
                {task.name}
              </span>
