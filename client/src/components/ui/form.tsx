...
>({
  ...
  // Subscribe to formState so the Controller re-renders children
  // (like FormMessage) when validation errors change
  const { formState } = useFormContext<TFieldValues>();
  // Access errors to activate the subscription proxy
