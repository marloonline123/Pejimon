...
import type { TaskSchema, TaskQuerySchema } from "../../modules/tasks/task.schema.js";
export declare const index: (req: Request<{}, {}, {}, TaskQuerySchema>, res: Response) => Promise<void>;
